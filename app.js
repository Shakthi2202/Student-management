/* ============================================
   Campus Connect — app.js
   Core shared logic: toasts, course data, enrollment & progress.
   Plain script (no import/export) — load this BEFORE auth.js
   and before any page-specific script, e.g.:
